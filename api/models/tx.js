...
const tokenValues = Object.assign(
  {
    ...
    'o1-mini': { prompt: 2.56, completion: 10.2 },
    ...
    // Anthropic models
    'claude-3-5-sonnet-latest': { prompt: 2.56, completion: 12.75 },
    'claude-3-5-sonnet-20240620': { prompt: 2.56, completion: 12.75 },
    'claude-3-5-haiku-20241022': { prompt: 0.68, completion: 3.4 },
    'claude-3-opus-20240229': { prompt: 12.78, completion: 63.75 },
    ...
    'claude-3-opus': { prompt: 17.8, completion: 88.24 },
    ...
    'accounts/fireworks/models/flux-1-schnell-fp8': { prompt: 2.13, completion: 8.5 },
    'accounts/fireworks/models/flux-1-dev-fp8': { prompt: 2.13, completion: 8.5 },
    ...
    'accounts/fireworks/models/firefunction-v2-rc': { prompt: 2.13, completion: 8.5 },
    ...
    'accounts/fireworks/models/firefunction-v2': { prompt: 2.13, completion: 8.5 },
    ...
    'accounts/marco-0dece6/models/state-transition-llama3p1': { prompt: 2.13, completion: 8.5 },
    ...
    'accounts/fixie/models/1b68538a063a49e2ae4513d4ef186e9a': { prompt: 2.13, completion: 8.5 },
    'accounts/fireworks/models/firefunction-v1': { prompt: 2.13, completion: 8.5 },
    ...
    'openai/gpt-4o-2024-11-20': { prompt: 2.13, completion: 8.5 },
    ...
    'openai/chatgpt-4o-latest': { prompt: 2.13, completion: 8.5 },
    'perplexity/llama-3.1-sonar-huge-128k-online': { prompt: 4.26, completion: 4.26 },
    'aetherwiing/mn-starcannon-12b': { prompt: 2.13, completion: 8.5 },
    'sao10k/l3-lunaris-8b': { prompt: 1.5, completion: 1.5 },
    'openai/gpt-4o-2024-08-06': { prompt: 2.13, completion: 8.5 },
    'meta-llama/llama-3.1-405b': { prompt: 2.13, completion: 8.5 },
    'nothingiisreal/mn-celeste-12b': { prompt: 2.13, completion: 8.5 },
    ...
    'meta-llama/llama-3.1-8b-instruct': { prompt: 2.13, completion: 8.5 },
    'meta-llama/llama-3.1-70b-instruct:free': { prompt: 0, completion: 0 },
    'meta-llama/llama-3.1-70b-instruct': { prompt: 2.13, completion: 8.5 },
    'meta-llama/llama-3.1-70b-instruct:nitro': { prompt: 2.13, completion: 8.5 },
    'meta-llama/llama-3.1-405b-instruct:free': { prompt: 0, completion: 0 },
    'meta-llama/llama-3.1-405b-instruct': { prompt: 2.13, completion: 8.5 },
    'meta-llama/llama-3.1-405b-instruct:nitro': { prompt: 2.13, completion: 8.5 },
    'mistralai/mistral-nemo': { prompt: 2.13, completion: 8.5 },
    'mistralai/codestral-mamba': { prompt: 2.13, completion: 8.5 },
    ...
    'google/gemma-2-27b-it': { prompt: 2.13, completion: 8.5 },
    'alpindale/magnum-72b': { prompt: 2.13, completion: 8.5 },
    'google/gemma-2-9b-it:free': { prompt: 0, completion: 0 },
    'google/gemma-2-9b-it': { prompt: 2.13, completion: 8.5 },
    'ai21/jamba-instruct': { prompt: 2.13, completion: 8.5 },
    '01-ai/yi-large': { prompt: 2.13, completion: 8.5 },
    ...
    'microsoft/phi-3-mini-128k-instruct': { prompt: 2.13, completion: 8.5 },
    'microsoft/phi-3-medium-128k-instruct:free': { prompt: 0, completion: 0 },
    'microsoft/phi-3-medium-128k-instruct': { prompt: 2.13, completion: 8.5 },
    'neversleep/llama-3-lumimaid-70b': { prompt: 2.13, completion: 8.5 },
    ...
    'openai/gpt-4o': { prompt: 2.13, completion: 8.5 },
    'openai/gpt-4o:extended': { prompt: 2.13, completion: 8.5 },
    'meta-llama/llama-guard-2-8b': { prompt: 2.13, completion: 8.5 },
    'openai/gpt-4o-2024-05-13': { prompt: 2.13, completion: 8.5 },
    'neversleep/llama-3-lumimaid-8b:extended': { prompt: 2.13, completion: 8.5 },
    'neversleep/llama-3-lumimaid-8b': { prompt: 2.13, completion: 8.5 },
    'meta-llama/llama-3-70b-instruct': { prompt: 2.13, completion: 8.5 },
    'meta-llama/llama-3-70b-instruct:nitro': { prompt: 2.13, completion: 8.5 },
    'meta-llama/llama-3-8b-instruct:free': { prompt: 0, completion: 0 },
    'meta-llama/llama-3-8b-instruct': { prompt: 2.13, completion: 8.5 },
    'meta-llama/llama-3-8b-instruct:extended': { prompt: 2.13, completion: 8.5 },
    'meta-llama/llama-3-8b-instruct:nitro': { prompt: 2.13, completion: 8.5 },
    'mistralai/mixtral-8x22b-instruct': { prompt: 1.35, completion: 1.35 },
    'microsoft/wizardlm-2-7b': { prompt: 2.13, completion: 8.5 },
    'microsoft/wizardlm-2-8x22b': { prompt: 2.13, completion: 8.5 },
    ...
    'lizpreciatior/lzlv-70b-fp16-hf': { prompt: 2.13, completion: 8.5 },
    ...
    'openrouter/auto': { prompt: 2.13, completion: 8.5 },
    'openai/gpt-4-1106-preview': { prompt: 7.13, completion: 21.38 },
    'openai/gpt-3.5-turbo-1106': { prompt: 2.5, completion: 5.0 },
    'google/palm-2-codechat-bison-32k': { prompt: 2.13, completion: 8.5 },
    'google/palm-2-chat-bison-32k': { prompt: 2.13, completion: 8.5 },
    ...
    'google/palm-2-codechat-bison': { prompt: 2.13, completion: 8.5 },
    'google/palm-2-chat-bison': { prompt: 2.13, completion: 8.5 },
    ...
    'openai/chatgpt-4o-latest': { prompt: 2.13, completion: 8.5 },
    'chatgpt-4o': { prompt: 2.13, completion: 8.5 },
    'chatgpt-4o-latest': { prompt: 2.13, completion: 8.5 },
    ...
    'openai/gpt-4o-2024-05-13': { prompt: 2.13, completion: 8.5 },
    'gpt-4o': { prompt: 2.13, completion: 8.5 },
    'gpt-4o-2024-05-13': { prompt: 2.13, completion: 8.5 },
