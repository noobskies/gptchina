...
const SocialButton: React.FC<SocialButtonProps> = ({
        ...
        try {
          ...
          const config: InitializeOptions = {
            ...
            apple: {
              ...
              redirectUri: `${process.env.DOMAIN_SERVER}/oauth/apple/callback`,
              scopes: ['name', 'email'],
  ...
  const handleNativeSocialLogin = useCallback(
    async (provider: 'google' | 'apple') => {
      try {
        ...
        const response = await fetch(`${serverDomain}/oauth/${provider}/mobile`, {
          method: 'POST',
          headers: {
  ...
  // For native platforms (Google or Apple)
