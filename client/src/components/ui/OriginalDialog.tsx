  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'hover:bg-token-main-surface-secondary text-gray-600 dark:text-gray-400 hover:bg-slate-100 dark:border-gray-600 dark:hover:bg-gray-700',
...
const DialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn('flex flex-col space-y-1.5 text-center sm:text-left text-gray-600 dark:text-gray-400', className)} {...props} />
);
DialogHeader.displayName = 'DialogHeader';

const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn('flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 text-gray-600 dark:text-gray-400', className)}
    {...props}
  />
);
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('text-lg font-semibold leading-none tracking-tight text-gray-600 dark:text-gray-400', className)}
    {...props}
  />
));
