  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'hover:bg-token-main-surface-secondary text-gray-600 hover:bg-slate-100 dark:border-gray-600 dark:text-gray-400 dark:hover:bg-gray-700',
...
const DialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      'flex flex-col space-y-1.5 text-center text-gray-600 dark:text-gray-400 sm:text-left',
      className,
    )}
    {...props}
  />
...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      'flex flex-col-reverse text-gray-600 dark:text-gray-400 sm:flex-row sm:justify-end sm:space-x-2',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      'text-lg font-semibold leading-none tracking-tight text-gray-600 dark:text-gray-400',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn('text-sm text-gray-600 text-muted-foreground dark:text-gray-400', className)}
    {...props}
  />
));
