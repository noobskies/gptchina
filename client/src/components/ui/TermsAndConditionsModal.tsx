        ...
        buttons={
          <>
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center rounded-lg border border-border-heavy bg-surface-secondary px-4 py-2 text-sm text-text-primary hover:bg-blue-500 hover:text-white focus:bg-blue-500 focus:text-white dark:hover:bg-blue-600 dark:focus:bg-blue-600"
            >
