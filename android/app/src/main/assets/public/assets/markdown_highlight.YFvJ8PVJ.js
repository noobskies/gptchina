  ...
  const n = {
    ...
    t = (function (e) {
      const n = e.regex,
        ...
        d = { className: 'title', begin: n.optional(i) + e.IDENT_RE, relevance: 0 },
  ...
  return {
    ...
    contains: [
      ...
      t.ATTRIBUTE_SELECTOR_MODE,
      {
        ...
        variants: [{ begin: ':(' + c.join('|') + ')' }, { begin: ':(:)?(' + d.join('|') + ')' }],
      },
      t.CSS_VARIABLE,
      { className: 'attribute', begin: '\\b(' + g.join('|') + ')\\b' },
      {
        begin: /:/,
        end: /[;}{]/,
        contains: [
      ...
      },
      {
        ...
        contains: [
          { className: 'keyword', begin: /@-?\w[\w]*(-\w+)*/ },
          {
            ...
            excludeEnd: !0,
            relevance: 0,
            keywords: { $pattern: /[a-z-]+/, keyword: 'and or not only', attribute: l.join(' ') },
...
var f = '[0-9](_*[0-9])*',
  ...
  y = {
    className: 'number',
    variants: [
      { begin: `(\\b(${f})((${_})|\\.)?|(${_}))[eE][+-]?(${f})[fFdD]?\\b` },
      { begin: `\\b(${f})((${_})[fFdD]?\\b|\\.([fFdD]\\b)?)` },
      { begin: `(${_})[fFdD]?\\b` },
      { begin: `\\b(${f})[fFdD]\\b` },
      { begin: `\\b0[xX]((${E})\\.?|(${E})?\\.(${E}))[pP][+-]?(${f})[fFdD]?\\b` },
...
function w(e, n, t) {
  return -1 === t ? '' : e.replace(n, (a) => w(e, n, t - 1));
}
function v(e) {
  const n = e.regex,
        ...
        contains: [
          {
            ...
            keywords: i,
            relevance: 0,
            contains: [r, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, y, e.C_BLOCK_COMMENT_MODE],
          },
          e.C_LINE_COMMENT_MODE,
          e.C_BLOCK_COMMENT_MODE,
        ],
...
const N = '[A-Za-z$_][0-9A-Za-z$_]*',
  ...
  x = ['true', 'false', 'null', 'undefined', 'NaN', 'Infinity'],
  O = [
    'Object',
    'Function',
    'Boolean',
...
function T(e) {
  const n = e.regex,
    ...
    s = { $pattern: N, keyword: k, literal: x, built_in: C, 'variable.language': A },
    o = '[0-9](_?[0-9])*',
    l = `\\.(${o})`,
    ...
    g = { className: 'subst', begin: '\\$\\{', end: '\\}', keywords: s, contains: [] },
    u = {
      begin: 'html`',
      end: '',
    ...
    p = { className: 'string', begin: '`', end: '`', contains: [e.BACKSLASH_ESCAPE, g] },
    h = {
      className: 'comment',
      variants: [
        e.COMMENT(/\/\*\*(?!\/)/, '\\*/', {
    ...
    f = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, u, b, m, p, { match: /\$\d+/ }, d];
  g.contains = f.concat({ begin: /\{/, end: /\}/, keywords: s, contains: ['self'].concat(f) });
  const _ = [].concat(h, g.contains),
    E = _.concat([{ begin: /\(/, end: /\)/, keywords: s, contains: ['self'].concat(_) }]),
    y = {
      className: 'params',
      begin: /\(/,
      end: /\)/,
  ...
  const R = {
    match: n.concat(
      /\b/,
      ((I = [...S, 'super', 'import']), n.concat('(?!', I.join('|'), ')')),
      t,
      n.lookahead(/\(/),
    ),
  ...
  const D = {
    ...
    B =
      ...
      ')\\s*=>',
    $ = {
      match: [/const|var|let/, /\s+/, t, /\s*/, /=\s*/, /(async\s*)?/, n.lookahead(B)],
      keywords: 'async',
      className: { 1: 'keyword', 3: 'title.function' },
      contains: [y],
    };
  return {
    ...
    keywords: s,
    exports: { PARAMS_CONTAINS: E, CLASS_REFERENCE: v },
    illegal: /#(?![$_A-z])/,
    contains: [
...
var I = '[0-9](_*[0-9])*',
  ...
  B = {
    className: 'number',
    variants: [
      { begin: `(\\b(${I})((${D})|\\.)?|(${D}))[eE][+-]?(${I})[fFdD]?\\b` },
      { begin: `\\b(${I})((${D})[fFdD]?\\b|\\.([fFdD]\\b)?)` },
      { begin: `(${D})[fFdD]?\\b` },
      { begin: `\\b(${I})[fFdD]\\b` },
      { begin: `\\b0[xX]((${L})\\.?|(${L})?\\.(${L}))[pP][+-]?(${I})[fFdD]?\\b` },
      { begin: '\\b(0|[1-9](_*[0-9])*)[lL]?\\b' },
      { begin: `\\b0[xX](${L})[lL]?\\b` },
      { begin: '\\b0(_*[0-7])*[lL]?\\b' },
      { begin: '\\b0[bB][01](_*[01])*[lL]?\\b' },
...
function q(e) {
  const n = ((e) => ({
    ...
    c = { $pattern: /[a-z-]+/, keyword: 'and or not only', attribute: F.join(' ') },
  ...
  const g = s.concat({ begin: /\{/, end: /\}/, contains: r }),
    u = {
      beginKeywords: 'when',
      endsWithParent: !0,
    ...
    h = {
      ...
      contains: [
        ...
        l('keyword', 'all\\b'),
        l('variable', '@\\{' + a + '\\}'),
        { begin: '\\b(' + z.join('|') + ')\\b', className: 'selector-tag' },
        n.CSS_NUMBER_MODE,
        l('selector-tag', i, 0),
        l('selector-id', '#' + i),
        ...
        { className: 'selector-pseudo', begin: ':(:)?(' + P.join('|') + ')' },
        { begin: /\(/, end: /\)/, relevance: 0, contains: g },
        { begin: '!important' },
        n.FUNCTION_DISPATCH,
      ],
    },
    f = { begin: a + `:(:)?(${t.join('|')})`, returnBegin: !0, contains: [h] };
  return (
    r.push(e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, m, p, f, b, h, u, n.FUNCTION_DISPATCH),
...
function X(e) {
  const n = e.regex,
    ...
    y = {
      ...
      keywords: m,
      contains: [E, r, _, e.C_BLOCK_COMMENT_MODE, c, d, h],
    },
    w = {
      relevance: 0,
      match: [
  ...
  y.contains.push(w);
  const v = [E, _, e.C_BLOCK_COMMENT_MODE, c, d, h];
  return {
    case_insensitive: !1,
    keywords: m,
    contains: [
      ...
      h,
      {
        ...
        contains: [
          ...
          { begin: '=>', endsParent: !0 },
          {
            ...
            excludeEnd: !0,
            keywords: m,
            contains: ['self', r, _, e.C_BLOCK_COMMENT_MODE, c, d],
          },
        ],
      },
      {
  ...
  return (
    (s.contains = [l, u, r]),
    {
      ...
      contains: [
        ...
        b,
        e.HASH_COMMENT_MODE,
        { match: [/\bdef/, /\s+/, t], scope: { 1: 'keyword', 3: 'title.function' }, contains: [m] },
        {
          variants: [
  ...
  return {
    ...
    contains: [
      ...
      },
      {
        relevance: 0,
        variants: [
          { scope: { 1: 'operator', 2: 'number' }, match: [i, a] },
...
function te(e) {
  const n = e.regex,
    ...
    m = [
      ...
      { match: [/(include|extend)\s+/, i], scope: { 2: 'title.class' }, keywords: r },
  ...
  return {
    ...
    contains: [
      ...
      { begin: '@(page|font-face)', keywords: { $pattern: i, keyword: '@page @font-face' } },
      {
        ...
        returnBegin: !0,
        keywords: { $pattern: /[a-z-]+/, keyword: 'and or not only', attribute: re.join(' ') },
        contains: [
...
function pe(...e) {
  ...
  return '(' + (n.capture ? '' : '?:') + e.map((e) => ue(e)).join('|') + ')';
}
const he = (e) => me(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/),
  fe = ['Protocol', 'Type'].map(he),
  _e = ['init', 'self'].map(he),
  Ee = ['Any', 'Self'],
  ye = [
    'actor',
  ...
  we = ['false', 'nil', 'true'],
  ve = ['assignment', 'associativity', 'higherThan', 'left', 'lowerThan', 'none', 'right'],
  Ne = [
    '#colorLiteral',
    '#column',
    '#dsohandle',
  ...
  Ae = pe(Se, /\d/, /[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/),
  Ce = me(Se, Ae, '*'),
  Te = me(/[A-Z]/, Ae, '*'),
  Re = [
    'autoclosure',
    me(/convention\(/, pe('swift', 'block', 'c'), /\)/),
    'discardableResult',
    'dynamicCallable',
    'dynamicMemberLookup',
    'escaping',
...
function De(e) {
  const n = { match: /\s+/, relevance: 0 },
    ...
    i = { match: [/\./, pe(...fe, ..._e)], className: { 2: 'keyword' } },
    r = { match: me(/\./, pe(...ye)), relevance: 0 },
    s = ye.filter((e) => 'string' == typeof e).concat(['_|0']),
    o = {
      variants: [
        {
          className: 'keyword',
    ...
    l = { $pattern: pe(/\b\w+/, /#\w+/), keyword: s.concat(Ne), literal: we },
    c = [i, r, o],
    d = [
      { match: me(/\./, pe(...ke)), relevance: 0 },
      { className: 'built_in', match: me(/\b/, pe(...ke), /(?=\()/) },
    ],
    g = { match: /->/, relevance: 0 },
    u = [
      g,
    ...
    h = (e = '') => ({
      ...
      variants: [
        { match: me(/\\/, e, /[0\\tnr"']/) },
        { match: me(/\\/, e, /u\{[0-9a-fA-F]{1,8}\}/) },
      ],
    }),
    f = (e = '') => ({ className: 'subst', match: me(/\\/, e, /[\t ]*(?:[\r\n]|\r\n)/) }),
    _ = (e = '') => ({
      className: 'subst',
      label: 'interpol',
      begin: me(/\\/, e, /\(/),
    ...
    E = (e = '') => ({ begin: me(e, /"""/), end: me(/"""/, e), contains: [h(e), f(e), _(e)] }),
    y = (e = '') => ({ begin: me(e, /"/), end: me(/"/, e), contains: [h(e), _(e)] }),
    w = {
      className: 'string',
      variants: [E(), E('#'), E('##'), E('###'), y(), y('#'), y('##'), y('###')],
    },
    v = { match: me(/`/, Ce, /`/) },
    N = [
      v,
      { className: 'variable', match: /\$\d+/ },
      { className: 'variable', match: `\\$${Ae}+` },
    ],
    k = [
      {
        match: /(@|#(un)?)available/,
        className: 'keyword',
        starts: { contains: [{ begin: /\(/, end: /\)/, keywords: Ie, contains: [...u, p, w] }] },
      },
      { className: 'keyword', match: me(/@/, pe(...Re)) },
      { className: 'meta', match: me(/@/, Ce) },
    ],
    x = {
      match: be(/\b[A-Z]/),
      relevance: 0,
      contains: [
        {
          className: 'type',
          match: me(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/, Ae, '+'),
        },
        { className: 'type', match: Te, relevance: 0 },
        { match: /[?!]+/, relevance: 0 },
        { match: /\.\.\./, relevance: 0 },
        { match: me(/\s+&\s+/, be(Te)), relevance: 0 },
      ],
    },
    O = { begin: /</, end: />/, keywords: l, contains: [...a, ...c, ...k, g, x] };
  x.contains.push(O);
  const M = {
      begin: /\(/,
      end: /\)/,
      ...
      contains: [
        'self',
        { match: me(Ce, /\s*:/), keywords: '_|0', relevance: 0 },
        ...a,
        ...c,
        ...d,
        ...u,
    ...
    A = {
      ...
      contains: [
        {
          begin: pe(be(me(Ce, /\s*:/)), be(me(Ce, /\s+/, Ce, /\s*:/))),
          end: /:/,
          relevance: 0,
          contains: [
    ...
    R = { match: [/operator/, /\s+/, Me], className: { 1: 'keyword', 3: 'title' } },
    I = {
  ...
  for (const D of w.variants) {
    const e = D.contains.find((e) => 'interpol' === e.label);
    e.keywords = l;
    const n = [...c, ...d, ...u, p, w, ...N];
    e.contains = [...n, { begin: /\(/, end: /\)/, contains: ['self', ...n] }];
  }
  return {
    name: 'Swift',
    keywords: l,
...
const Le = '[A-Za-z$_][0-9A-Za-z$_]*',
  ...
  $e = ['true', 'false', 'null', 'undefined', 'NaN', 'Infinity'],
  ze = [
    'Object',
    'Function',
    'Boolean',
...
function Ke(e) {
  const n = (function (e) {
      const n = e.regex,
        ...
        s = { $pattern: Le, keyword: Be, literal: $e, built_in: je, 'variable.language': Pe },
        o = '[0-9](_?[0-9])*',
        l = `\\.(${o})`,
        c = '0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*',
        d = {
      ...
      const _ = [].concat(h, g.contains),
        ...
        k = {
          match: n.concat(
            /\b/,
            ((x = [...Ue, 'super', 'import']), n.concat('(?!', x.join('|'), ')')),
            t,
            n.lookahead(/\(/),
          ),
          className: 'title.function',
    ...
    contains: [
      {
        ...
        contains: [
          ...
          r,
          {
            ...
            contains: [{ className: 'meta', begin: /<![a-z]/, end: />/, contains: [i, r, o, s] }],
          },
        ],
      },
...
function Xe() {
  ...
  const _ = '[a-zA-Z]\\w*',
    ...
    S = O('/\\*', '\\*/'),
    A = O('#', '$'),
    C = { scope: 'number', begin: y, relevance: 0 },
    T = { scope: 'number', begin: w, relevance: 0 },
    ...
    D = { scope: 'title', begin: _, relevance: 0 },
    L = { scope: 'title', begin: E, relevance: 0 },
    B = { begin: '\\.\\s*' + E, relevance: 0 };
  var $ = Object.freeze({
    __proto__: null,
  ...
  function ee(e, n, { key: t }) {
    ...
    const i = e[t],
      r = {},
      s = {};
    for (let o = 1; o <= n.length; o++) (s[o + a] = i[o]), (r[o + a] = !0), (a += p(n[o - 1]));
      ...
      (function (e) {
        if (Array.isArray(e.begin)) {
          if (e.skip || e.excludeBegin || e.returnBegin)
            throw (X('skip, excludeBegin, returnBegin not compatible with beginScope: {}'), Y);
          if ('object' != typeof e.beginScope || null === e.beginScope)
            throw (X('beginScope must be object'), Y);
          ee(e, e.begin, { key: 'beginScope' }), (e.begin = f(e.begin, { joinWith: '' }));
        }
      })(e),
      (function (e) {
        if (Array.isArray(e.end)) {
          if (e.skip || e.excludeEnd || e.returnEnd)
            throw (X('skip, excludeEnd, returnEnd not compatible with endScope: {}'), Y);
          if ('object' != typeof e.endScope || null === e.endScope)
            throw (X('endScope must be object'), Y);
          ee(e, e.end, { key: 'endScope' }), (e.end = f(e.end, { joinWith: '' }));
        }
      })(e);
  }
  function te(e) {
          ...
          (r.contains = [].concat(
            ...r.contains.map(function (e) {
              return (function (e) {
                ...
                if (ae(e)) return a(e, { starts: e.starts ? a(e.starts) : null });
  ...
  const re = t,
    ...
    le = function (t) {
      ...
      function _(e, t, i, r) {
        ...
        function c() {
          if (!O.keywords) return void S.addText(A);
          let e = 0;
          O.keywordPatternRe.lastIndex = 0;
          let n = O.keywordPatternRe.exec(A),
            t = '';
          for (; n; ) {
            ...
            (e = O.keywordPatternRe.lastIndex), (n = O.keywordPatternRe.exec(A));
          }
          var a;
        ...
        function b(e, n) {
          return (
            e.scope &&
              ...
              S.openNode(v.classNameAliases[e.scope] || e.scope),
            e.beginScope &&
              (e.beginScope._wrap
                ? (g(A, v.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (A = ''))
        ...
        function h(e) {
          return 0 === O.matcher.regexIndex ? ((A += e[0]), 1) : ((I = !0), 0);
        }
        function f(e) {
          const n = e[0],
        ...
        function w(a, r) {
          ...
          if ('illegal' === r.type && !i) {
            const e = new Error(
              'Illegal lexeme "' + o + '" for mode "' + (O.scope || '<unnamed>') + '"',
            );
            throw ((e.mode = O), e);
          }
          if ('end' === r.type) {
        ...
        const v = N(e);
        if (!v) throw (X(o.replace('{}', e)), new Error('Unknown language: "' + e + '"'));
        const k = te(v);
        let x = '',
          O = r || k;
        const M = {},
        ...
        let A = '',
          ...
          I = !1;
        try {
          if (v.__emitTokens) v.__emitTokens(t, S);
          else {
          ...
          return (
            S.finalize(),
            (x = S.toHTML()),
            { language: e, value: x, relevance: C, illegal: !1, _emitter: S, _top: O }
          );
        } catch (D) {
      ...
      function y(e) {
        ...
        const t = (function (e) {
          ...
          return n.split(/\s+/).find((e) => h(e) || N(e));
        })(e);
        if (h(t)) return;
        if (
        ...
        (e.innerHTML = r.value),
          ...
          r.secondBest &&
            (e.secondBest = { language: r.secondBest.language, relevance: r.secondBest.relevance }),
      ...
      'undefined' != typeof window &&
        ...
        Object.assign(t, {
          ...
          initHighlighting: () => {
            v(), J('10.6.0', 'initHighlighting() deprecated.  Use highlightAll() now.');
          },
          initHighlightingOnLoad: function () {
            v(), J('10.6.0', 'initHighlightingOnLoad() deprecated.  Use highlightAll() now.');
          },
          registerLanguage: function (e, n) {
            ...
            try {
              ...
              if ((X("Language definition for '{}' could not be registered.".replace('{}', e)), !s))
                throw r;
              X(r), (i = c);
            }
            i.name || (i.name = e),
              ...
              i.aliases && k(i.aliases, { languageName: e });
          },
        ...
        (t.versionString = '11.8.0'),
        (t.regex = { concat: b, lookahead: d, either: m, optional: u, anyNumberOfTimes: g });
      for (const n in $) 'object' == typeof $[n] && e($[n]);
      return Object.assign(t, $), t;
    },
    ce = le({});
  return (ce.newInstance = () => le({})), (We = ce), (ce.HighlightJS = ce), (ce.default = ce), We;
}
const Ve = n(Xe());
export {
  ee as A,
